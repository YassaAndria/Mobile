...
const audioStorage = new CloudinaryStorage({
  ...
  params: {
    ...
    allowed_formats: ['mp3', 'wav', 'ogg', 'webm', 'm4a', 'mp4', 'aac'],
  } as any,
});

const audioFilter = (req: any, file: any, cb: any) => {
  // Accept standard audio mimetypes + audio/mp4 (Android .m4a recordings)
  if (
    file.mimetype.startsWith('audio') ||
    file.mimetype.includes('webm') ||
    file.mimetype === 'audio/mp4' ||
    file.mimetype === 'audio/m4a' ||
    file.mimetype === 'video/mp4' // some Android devices report m4a as video/mp4
  ) {
    cb(null, true);
  } else {
